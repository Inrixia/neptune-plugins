...
`);import{html as k}from"@neptune/voby";import{storage as g}from"@plugin";var d={HiRes:"HI_RES_LOSSLESS",MQA:"HI_RES",High:"LOSSLESS"},w=Object.values(d),v=new Set(w),I=[d.HiRes,d.High],u=Object.fromEntries(Object.entries(d).map(([e,t])=>[t,e])),J={LOSSLESS:d.High,HIRES_LOSSLESS:d.HiRes,MQA:d.MQA};g.desiredDownloadQuality=d.HiRes;var A=()=>k`<div class="settings-section">
